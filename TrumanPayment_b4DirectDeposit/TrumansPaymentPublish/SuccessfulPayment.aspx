    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('input[type="radio"]').click(function () {
                ...
                if ($(this).attr("value") == "Bank Account") {
...
<body>
    <div style="align-content:center">
        <iframe src="http://www.trumans.com.au/" id="headerFrame" height="371px" width="100%" scrolling="no"></iframe>
    </div>
    <div class="main_area">
...
<div id="successmsg" runat="server">                            <h1>
                            ...
                            <p style="text-align: justify;">
                               <b>  <asp:Label ID="Label4" runat="server" Text="" Style="position:absolute;margin-top:51px; margin-left:120px; font-size:16px; color:darkblue;"></asp:Label></b>
