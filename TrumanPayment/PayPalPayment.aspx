<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayPalPayment.aspx.cs" Inherits="TrumanPayment.PayPalPayment" %>
...
<body>
    <form runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Text="Redirecting..... Please Wait!!"></asp:Label>
    </div>
