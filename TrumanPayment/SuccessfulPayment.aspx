...
<div id="successmsg" runat="server">                            <h1>
    ...
    <a style="cursor:pointer;" id="DDFilelink" runat="server" visible="false"> Click here to download ABA File</a>
                            ...
                            <p style="text-align: center;">                                
                               <b>  
                                   <asp:Label ID="Label2" runat="server" Text="" Style="position:absolute;margin-top:30px; margin-left:180px; font-size:16px; color:darkblue;"></asp:Label>
                                   <asp:Label ID="Label4" runat="server" Text="" Style="position:absolute;margin-top:51px; margin-left:120px; font-size:16px; color:darkblue;"></asp:Label></b>
