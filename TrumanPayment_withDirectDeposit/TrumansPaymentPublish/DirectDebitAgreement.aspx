...
[insert name of Debit User & contact details]
        ...
        <div style="text-align: center; padding : 20px;"> 
            <asp:button id="btnBack" runat="server" type="button" text="Back" onclick="javascript:window.location.href = 'Default.aspx'" />&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnAgree" runat="server" Text="I agree" OnClick="btnAgree_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:button runat="server" id="btnDecline" type="button" text="I Decline" onclick="javascript: window.location.href = 'Default.aspx?dd=decline'" /></div>
      </div> 
                          </div> 
   </div>
    </div>
