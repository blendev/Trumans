            ...
            <div class="mainbody_repeat">
                <div class="mainbody_margin_bottom">
                    <div class="mainbody_margin_top">
						...
						<h3>Direct Deposit Details</h3><br>
						<table style="width:100%">
                            <tr><td>
                           Account Name</td><td>  <input id="DDAccName" type="text" runat="server" /></td></tr>
                           <tr><td>
                           Branch Number(BSB)</td><td>  <asp:textbox id="DDBranchNum" type="tel" runat="server" /></td></tr>
                             <tr><td>
                           Account Number</td><td>  <asp:textbox id="DDAccNum" type="tel" runat="server" /></td></tr>
							<tr><td></td><td> 
                                <asp:button ID="btnDDCont" runat="server" Text="Continue" style="color: #666; float: right;  margin-left: 20px;  font-size: 14px;
                                      height: 28px;
                                      line-height: 28px;
                                      overflow: visible;
                                      border: 0px;
                                      ...
                                      min-width: 110px;
                                      background: url(https://www.my.telstra.com.au/myaccount/static-content/css/images/lightbox-btn-hover-bg.png) repeat-x center;
                                      padding: 0px 10px;"  OnClick="btnDDCont_Click"/>
                                </td></tr>
							</table>
                        </div>
